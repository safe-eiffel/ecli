...
2004-Q1
	. Maximum length can be specified for long data.
	. A class for EPOM-compliant extended accesses can be generated by specifying the
	  -access_routines_prefix parameter
